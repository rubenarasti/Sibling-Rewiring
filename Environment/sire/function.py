...
def  logarithmic_cooling_sequence(initial_t, it, alpha):
	"""
...
def solve_simulated_annealing(G, matrix, siblings, totalStudents, l, tf, alpha, option_cooling, seed_value, percentage_component):
	"""
	...
	while t >= tf:
		...
		if option_cooling == 1:        
			...
			t = logarithmic_cooling_sequence(initial_t, it, alpha)
			...
			t = geometrical_cooling_sequence(alpha, t)
